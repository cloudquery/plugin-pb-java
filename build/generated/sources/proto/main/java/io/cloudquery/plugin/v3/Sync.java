    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tableName_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, tableName_);
          ...
          {
            final int count = whereClause_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(whereClause_.get(i));
            }
            size += 1 * count;
          }

          {
            final int count = tableRelations_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(tableRelations_.get(i));
            }
            size += 1 * count;
          }
      size += getUnknownFields().getSerializedSize();
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                ensureTablesIsMutable();
                tables_.add(input.readStringRequireUtf8());
                break;
              } // case 10
              case 18: {
                ensureSkipTablesIsMutable();
                skipTables_.add(input.readStringRequireUtf8());
                break;
              } // case 18
              case 24: {
